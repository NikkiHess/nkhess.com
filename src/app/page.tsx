...
const Home = () => (
  <div id={indexStyles.homeContainer}>
    <div id={indexStyles.innerHome}>
      ...
      <iframe id={indexStyles.itchEmbed}  src="https://itch.io/embed-upload/12205847?linkback=true&amp;bg_color=000000&amp;fg_color=ffffff&amp;link_color=23b14d&amp;border_color=ffffff" allowfullscreen="" width="550" height="165">
